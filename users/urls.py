...
from .views import HomeView, UserCreateView, VerifyOtpView, RegenerateOtpView, ForgotPasswordView, VerifyForgotOtpView, LogoutView, ValidateTokenView, ChangePasswordView
